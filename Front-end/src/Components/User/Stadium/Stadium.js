...
return(
<div key={index} className="d-flex justify-content-center mt-5 "><Card nom={element.name} iduser={id} location={element.location} loc={location} avis={5} photo={`http://localhost:4000/images/${element.id}/picture.jpeg`} id={element.id}/></div>
