...
<div className='h3'>Loading</div>
      ...
      <div className="col-6"><div className="card  mt-5 bg-card pt-5" style={{cursor:'pointer',height:'684px'}} data-bs-toggle="modal" data-bs-target="#exampleModal70">
...
<div className="d-flex justify-content-center ms-4 ">
    ...
    <div className="modal fade" id="exampleModal70" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">

  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      <div className='d-flex justify-content-end'>
        <button type="button" id='changed5' className="btn-close bordering2" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        
        <div className='d-flex justify-content-center'>
        <div class="modal-title text-center  "  style={{fontSize:'22px'}} id="exampleModalLabel">Add new Stadium</div></div>
      </div>
      <div class="modal-body">
